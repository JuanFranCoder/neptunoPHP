	...
	<body>
		...
		<!-- Signup Form -->
			<form id="filtrar" method="post" action="">
				<input type="text" name="IdCliente" id="IdCliente" placeholder="Filtrar por IdCliente" />
				<input type="submit" value="Buscar" />
			</form>

		<!-- volver a listado de empleados -->
			<a href="./empleados.php">Volver al listado de empleados</a>
			
        <!-- Tabla de clientes -->
<?php include('php/pedidosPorEmpleadoBD.php') ?>
		<!-- Footer -->
			<footer id="footer">
				<ul class="icons">
